...
const EntryDesk = () => {
  ...
  return (
    <div className="space-y-6">
      <h2 className="text-2xl font-black text-[#FAF3E1]">Entry Desk</h2>

      <form onSubmit={onEntry} className="grid grid-cols-1 md:grid-cols-3 gap-3 bg-[#FAF3E1]/2 p-5 rounded-2xl border border-[#F5E7C6]/10">
        <input
          value={bookingCode}
      ...
      <div className="bg-[#FAF3E1]/2 p-5 rounded-2xl border border-[#F5E7C6]/10">
        <h3 className="text-[#FAF3E1] font-black mb-3">Entry Activity Log</h3>
